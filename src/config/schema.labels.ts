...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "channels.signal.sseIdleTimeoutMs": "Signal SSE Idle Timeout (ms)",
  "channels.signal.retry.attempts": "Signal Retry Attempts",
  "channels.signal.retry.minDelayMs": "Signal Retry Min Delay (ms)",
  "channels.signal.retry.maxDelayMs": "Signal Retry Max Delay (ms)",
